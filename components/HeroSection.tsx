...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col">
      {/* Top bar */}
      <nav className="flex justify-between items-center px-6 sm:px-10 lg:px-16 py-6 animate-[fadeIn_0.6s_ease-out_both]">
      ...
      {/* Main content area */}
      <div className="flex-1 relative px-6 sm:px-10 lg:px-16">
        {/* Title — absolutely positioned */}
        <div className="absolute top-[10%] left-6 sm:left-10 lg:left-16 animate-[slideUp_0.7s_ease-out_0.1s_both]">
          <h1 className="leading-[0.88]">
            <span className="block font-airnt uppercase text-[clamp(4rem,13vw,13rem)] tracking-tight">Design</span>
            <span className="relative flex items-start">
              ...
              <span className="font-airnt uppercase text-[clamp(4rem,13vw,13rem)] tracking-tight sm:ml-[calc(clamp(3rem,8vw,8rem)+1.25rem)]">Week</span>
            </span>
            <span className="block font-airnt uppercase text-[clamp(2rem,7vw,6.5rem)] tracking-tight leading-[0.88]">Freetown</span>
      ...
      <div className="px-6 sm:px-10 lg:px-16 py-6 flex flex-col lg:flex-row lg:justify-between lg:items-end gap-6 animate-[fadeIn_0.6s_ease-out_0.6s_both]">
